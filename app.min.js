...
var Palette = React.createClass({displayName: "Palette",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "palette", style: {background: c, color: text}}, 

        React.createElement("div", {id: "nav"}, 
          React.createElement("div", {id: "logo"}, 
            React.createElement("h1", null, "palettor")
          )
        ), 

        React.createElement(Display, {handleClick: this.setColor, color: c}), 

        React.createElement("div", {id: "footer"}, 
          React.createElement("a", {style: {color: text}, href: "https://twitter.com/conniecodes"}, React.createElement("i", {className: "fa fa-twitter"})), 
          React.createElement("a", {style: {color: text}, href: "https://github.com/conniegiann/palettor.v2"}, React.createElement("i", {className: "fa fa-github-alt"}))
        )
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {id: "display"}, 
        React.createElement("p", {className: "color-text"}, c), 
        React.createElement("p", {className: "color-text"}, colors.hexToRGB(c)), 
        React.createElement("div", {className: "new-color", onClick: this.props.handleClick, class: "color-new"}, "random color")
      )
    )
  }
})
...
React.render(React.createElement(Palette, null), document.getElementById("app"), function() {
  console.log('React rendered...')
});

},{"./colors.js":158,"react":156}],158:[function(require,module,exports){
