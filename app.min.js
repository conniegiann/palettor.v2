...
var Palette = React.createClass({displayName: "Palette",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "palette", style: {background: this.state.color}}, 
  
        React.createElement("div", {id: "nav"}, 
          React.createElement("div", {id: "logo"}, 
            React.createElement("h1", null, "palettor")
          ), 
          React.createElement("div", {id: "permalink"})
        ), 

        React.createElement("div", {id: "box"}, 
          React.createElement("div", {id: "hex"}, this.state.color), 
          React.createElement("div", {id: "rgb"}, colors.hexToRGB(this.state.color))
        ), 

        React.createElement("div", {id: "footer"}, 
          React.createElement("div", {id: "tweet"}), 
          React.createElement("div", {id: "github"})
        )
